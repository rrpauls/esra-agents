...
- `v0.2.2` — OpenClaw prerelease. The isolated OpenClaw 2026.9.1 gate passed exact remote Git installation, native plugin inspection, Workshop scanning, authenticated revision-bound apply, automatic rollback, and terminal-state retention. It supersedes `v0.2.0` and `v0.2.1`.
