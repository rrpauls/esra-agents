...
- `v0.2.1` — OpenClaw prerelease. The isolated OpenClaw 2026.9.1 gate passed exact remote Git installation, native plugin inspection, Workshop scanning, authenticated revision-bound apply, and automatic rollback. It supersedes `v0.2.0`, whose source package omitted compiled JavaScript.
